...
export default function Section1() {
  return (
    <section className="padding-block-900 fs-body">
      <div className="even-columns">
        <div className="margin center body">
          <h2 className="fs-primary-heading fw-bold padding-block-700">
            What's diffrent about Sticky?
          </h2>
          <p className="fs-body">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum
            minima nesciunt provident maxime beatae voluptatibus non eaque dolor
            nam? Quas dolores repellat corrupti voluptate ipsum cum. Ab
            similique cumque illo.
          </p>
        </div>
